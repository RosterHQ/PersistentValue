...
class PropertyWrapper: XCTestCase {
    ...
    func testKeyChainWithInitialValueInt() {
        let value1 = keyChainIntWithInitialValue
        XCTAssert(value1 == 1, "\(String(describing: value1)) != 1")
        
        keyChainIntWithInitialValue = 2
        
        let value2 = keyChainIntWithInitialValue
        XCTAssert(value2 == 2, "\(String(describing: value2)) != 2")
