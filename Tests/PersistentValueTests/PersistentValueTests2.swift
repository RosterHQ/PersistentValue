...
class PersistentValueTests2: XCTestCase {
    ...
    static var allTests = [
        ("testReadingStringUserDefaultsTypeFromPriorRetrieval", testReadingStringUserDefaultsTypeFromPriorRetrieval),
        ("testReadingIntUserDefaultsTypeFromPriorRetrieval", testReadingIntUserDefaultsTypeFromPriorRetrieval),
        ("testReadingStringKeyChainTypeFromPriorRetrieval", testReadingStringKeyChainTypeFromPriorRetrieval),
        ("testReadingIntKeyChainTypeFromPriorRetrieval", testReadingIntKeyChainTypeFromPriorRetrieval),
        ("testReadingStringFileTypeFromPriorRetrieval", testReadingStringFileTypeFromPriorRetrieval),
        ("testReadingIntFileTypeFromPriorRetrieval", testReadingIntFileTypeFromPriorRetrieval),
        ("testReadingDataUserDefaultsTypeFromPriorRetrieval", testReadingDataUserDefaultsTypeFromPriorRetrieval),
        ("testReadingDataKeyChainTypeFromPriorRetrieval", testReadingDataKeyChainTypeFromPriorRetrieval),
        ("testReadingDataFileTypeFromPriorRetrieval", testReadingDataFileTypeFromPriorRetrieval)
    ]
}
